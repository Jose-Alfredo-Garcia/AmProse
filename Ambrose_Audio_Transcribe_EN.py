...
def translate_transcribe(input_audio, input_recognizer, i, input_language, output_language):
    ...
    with sr.AudioFile(input_audio) as source:
        ...
        try:
            ...
            translated = translator.translate(transcription, src= input_language, dest= output_language)
            print('Minute', i, '\n', transcription, '\n', translated)
            text_value = f"\n Minute {i} \n {transcription} \n {translated}"
...
def split_and_transcribe_audio(input_file, output_folder, input_language, output_language, chunk_length_ms=60000):
    # Load the audio file
    ...
    for i in range(num_chunks):
        ...
        translate_transcribe(chunk_file, recognizer, i, input_language, output_language)
    ...
    if len(audio) % chunk_length_ms >= 10000:
        ...
        translate_transcribe(chunk_file, recognizer, num_chunks, input_language, output_language)
...
input_file = "samples_audio/godzila.mp3"
output_folder = "samples_audio"
input_language = "ja"
output_language = "en"
split_and_transcribe_audio(input_file, output_folder, input_language, output_language )